...
def create_app():
    ...
    # ✅ CORREÇÃO: Configuração CORS ÚNICA - Removido o after_request duplicado
    CORS(app, 
    ...
    # ✅ CORREÇÃO: Inicialização correta dos DAOs
    ...
    # ✅ CORREÇÃO: Inicialização correta dos Services
    ...
    tarefa_service = TarefaService(
        ...
        projeto_dao_dependency=projeto_dao,
        usuario_dao_dependency=usuario_dao  # ✅ CORREÇÃO: Adicionado usuario_dao
    )
    
    # ✅ CORREÇÃO: Inicialização correta dos Controls
    ...
    # ✅ CORREÇÃO: Registro correto dos blueprints
    ...
    # ✅ CORREÇÃO: REMOVIDO o @app.after_request duplicado que causava CORS múltiplo
    ...
    print("✅ CORS configurado corretamente (sem duplicação)")
    print("=" * 50)
...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            print("💡 O servidor não conseguiu reiniciar. Verifique os logs.")